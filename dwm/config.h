...
static const char col_purple[]      = "#532d8c";
static const char col_peach[]       = "#db8f8f";
...
static const char *colors[][3]      = {
	...
	[SchemeSel]   = { col_purple, col_peach, col_purple },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_peach, "-sf", col_purple, NULL };
